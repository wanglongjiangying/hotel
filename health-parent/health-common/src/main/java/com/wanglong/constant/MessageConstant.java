...
public class MessageConstant {
    ...
    public static final String ADD_FLOOR_SUCCESS = "新增楼层成功";
    public static final String ADD_FLOOR_FAIL = "新增楼层失败";

    //房间
    public static final String DELETE_ROOM_SUCCESS = "删除房间成功";
    public static final String DELETE_ROOM_FAIL = "删除房间失败";
    public static final String EDIT_ROOM_SUCCESS = "修改房间成功";
    public static final String EDIT_ROOM_FAIL = "修改房间失败";
    public static final String ADD_ROOM_SUCCESS = "新增房间成功";
    public static final String ADD_ROOM_FAIL = "新增房间失败";

    //房型
    public static final String DELETE_ROOM_TYPE_SUCCESS = "删除房型成功";
    public static final String DELETE_ROOM_TYPE_FAIL = "删除房型失败";
    public static final String EDIT_ROOM_TYPE_SUCCESS = "修改房型成功";
    public static final String EDIT_ROOM_TYPE_FAIL = "修改房型失败";
    public static final String ADD_ROOM_TYPE_SUCCESS = "新增房型成功";
    public static final String ADD_ROOM_TYPE_FAIL = "新增房型失败";

    //图片上传
    public static final String PHOTO_UPLOAD_SUCCESS = "图片上传成功";
    public static final String PHOTO_UPLOAD__FAIL = "图片上传失败";

    //控制楼层的选择
    public static final String ONLY_SELECTONE_ROOMTYPE = "只能选择一个房型";
    public static final String ONLY_SELECTONE_FLOOR = "只能选择一个楼层";

    public static final String DELETE_ACCOUNT_SUCCESS = "删除客户成功";
    public static final String DELETE_ACCOUNT_FAIL = "删除客户失败";
    public static final String EDIT_ACCOUNT_SUCCESS = "修改客户成功";
    public static final String EDIT_ACCOUNT_FAIL = "修改客户失败";
    public static final String ADD_ACCOUNT_SUCCESS = "新增客户成功";
    public static final String ADD_ACCOUNT_FAIL = "新增客户失败";
